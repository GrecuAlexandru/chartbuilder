...
const demoString = `{ "chartType": "bar", "data": [ { "label": "Label1", "dataSeries": [ { "dataSeriesLabel": "Category1", "dataSeriesValue": 4 } ] }, { "label": "Label2", "dataSeries": [ { "dataSeriesLabel": "Category1", "dataSeriesValue": 7 } ] }, { "label": "Label3", "dataSeries": [ { "dataSeriesLabel": "Category1", "dataSeriesValue": 2 } ] } ], "xAxis": { "enabled": true }, "yAxis": { "enabled": true }, "cartesianGrid": { "enabled": true, "backgroundFill": "transparent" }, "legend": { "enabled": true }, "keyLabels": [ { "enabled": true, "dataKey": "Category1" } ], "valueLabels": [ { "enabled": true, "dataKey": "Category1" } ] }`
